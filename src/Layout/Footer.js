...
import ItemPostPopup from "../components/menu/ItemPostPopup";
    ...
    <>
      ...
      <footer className="bg-white fixed bottom-0 left-0 w-full p-3 flex justify-around items-center border-t ">
        ...
        <button
          ...
          className="bg-gradient-to-r from-purple-100 to-blue-100 p-2 rounded-full absolute -top-6 shadow-xl"
        >
          <svg
